...
class WeekDaysChips extends StatelessWidget {
  ...
  const WeekDaysChips({Key? key, required this.selected, required this.callback}) : super(key: key);
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            ...
            color: selected.contains(weekDay.toString()) ? Theme.of(context).primaryColor : Colors.white
        ),
        child: Center(child: Text(weekDays[weekDay]),)
    ),);
  }
}
